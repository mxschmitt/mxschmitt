...
- 🔭&nbsp;I’m currently working on [Playwright for .NET](https://github.com/microsoft/playwright-dotnet) and [Playwright for Python](https://github.com/microsoft/playwright-python)
